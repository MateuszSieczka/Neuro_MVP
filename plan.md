...
6. **VRP STD:** Pre spike train 100Hz przez 500ms → effective weight spada do <30% po 200ms, recovery w ~1s
7. **Structural plasticity:** Po 10 000 kroków: ≥ 5 nowych synaps powstało, ≥ 3 martwe usunięte
8. **G_max enforcement:** Nigdy `sum(|w_incoming|) > G_max` dla żadnego neuronu (invariant test)
9. **Regresja pamięci:** Test na O(N×k) pamięci zamiast O(N²)
